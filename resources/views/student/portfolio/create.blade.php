<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <a href="{{ route('student.portfolio.index') }}" class="text-indigo-600 hover:text-indigo-900">My Portfolio</a> / Add Item
        </h2>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('student.portfolio.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <label class="flex items-center">
                                <input type="checkbox" name="featured" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" @checked(old('featured'))>
                        ...
                        <div class="flex items-center justify-end gap-4">
                            ...
                            <x-primary-button>Create Portfolio Item</x-primary-button>
                        </div>
                    </form>
                </div>
            </div>
