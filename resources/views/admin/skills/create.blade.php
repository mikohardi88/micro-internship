...
<head>
  ...
  <title>Buat Kemampuan - Vinix Micro Internship</title>
  ...
  <main class="lg:ml-64 p-6 lg:p-10">
    ...
    <div class="mb-8">
      <h1 class="text-3xl font-bold text-gray-800">
        <a href="{{ route('admin.skills.index') }}" class="text-purple-600 hover:text-purple-800">Kemampuan</a> / Buat Kemampuan
      </h1>
    </div>
      ...
      <form method="POST" action="{{ route('admin.skills.store') }}">
        ...
        <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-200">
          ...
          <button type="submit" class="px-6 py-3 bg-purple-600 text-white rounded-lg font-medium hover:bg-purple-700">
            <i class="fas fa-save mr-2"></i>Buat Kemampuan
          </button>
        </div>
      </form>
    </div>
